...
public class HotelController {
	...
	@PostMapping(path="/addHotel",consumes = {MediaType.ALL_VALUE})
	...
	@DeleteMapping(path="/deleteHotel/{id}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/searchHotelById/{id}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/viewAllHotels",consumes = {MediaType.ALL_VALUE})
