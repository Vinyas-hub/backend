...
public class AdminController {
	...
	@PostMapping(path="/admin/add",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/admin/{adminId}",consumes = {MediaType.ALL_VALUE})
	...
	@DeleteMapping(path="/admin/{adminId}",consumes = {MediaType.ALL_VALUE})
	...
	@PutMapping(path="/admin/updateAdmin",consumes = {MediaType.ALL_VALUE})
