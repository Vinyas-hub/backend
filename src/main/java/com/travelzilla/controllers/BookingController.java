...
public class BookingController {
	...
	@PostMapping(path="/booking/makeBooking",consumes = {MediaType.ALL_VALUE})
	...
	@DeleteMapping(path="/booking/cancelBooking/{bookingId}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/booking/viewBooking/{bookingId}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/booking/booking/viewAllBookings",consumes = {MediaType.ALL_VALUE})
