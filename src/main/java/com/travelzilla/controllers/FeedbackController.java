...
public class FeedbackController {
	...
	@PostMapping(path="/addfeedback",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/feedbackbyfeedbackid/{id}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/feedbackbycustomerid/{id}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/feedbackbypackageid/{id}",consumes = {MediaType.ALL_VALUE})
	...
	@GetMapping(path="/viewallfeedbacks",consumes = {MediaType.ALL_VALUE})
