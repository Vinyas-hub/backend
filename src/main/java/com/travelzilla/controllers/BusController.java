...
//	Register New Bus .
	@PostMapping(path="/Bus/Register",consumes = {MediaType.ALL_VALUE})
...
// Register Bus Along with Existing Travels and route.
	@PostMapping(path="/Bus/RegisterWithIds/{Route_Id}/{Travel_Id}",consumes = {MediaType.ALL_VALUE})
...
//	Search Bus by id.
	@GetMapping(path="/Bus/GetById/{Bus_Id}",consumes = {MediaType.ALL_VALUE})
...
//	Get all Buses.
	@GetMapping(path="/Bus/GetAll",consumes = {MediaType.ALL_VALUE})
